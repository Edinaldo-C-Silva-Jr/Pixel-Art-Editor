namespace PixelArtEditor.Drawing_Tools.Tools
{
    internal class EraserTool : DrawingTool
    {
        ...
        {
            if (toolParameters.ClickLocation.HasValue && toolParameters.BackgroundColor.HasValue && toolParameters.Transparency.HasValue && toolParameters.PixelSize.HasValue)
            {
