...
{
    /// <summary>
    /// A command that has the data and methods necessary to undo and redo actions made by Rectangle type tools.
    /// </summary>
    public class RectangleCommand : IUndoRedoCommand
    {
        /// <summary>
        ...
        public RectangleCommand(Bitmap oldImage, Bitmap newImage, Point location)
        {
